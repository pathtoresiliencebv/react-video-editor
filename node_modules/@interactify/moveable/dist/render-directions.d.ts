...
export declare function renderAroundControls(moveable: MoveableManagerInterface<Partial<RenderDirections>>, React: Renderer, ableName?: string, renderDirections?: string[]): any[];
